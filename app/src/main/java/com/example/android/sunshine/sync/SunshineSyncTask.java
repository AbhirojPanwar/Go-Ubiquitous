    ...
    static synchronized public void syncWeather(Context context) {
        ...
        try {
            ...
            if (weatherValues != null && weatherValues.length != 0) {
                ...
                Cursor cursor=context.getContentResolver().query(WeatherContract.WeatherEntry.CONTENT_URI,new String[]{WeatherContract.WeatherEntry.COLUMN_MIN_TEMP,WeatherContract.WeatherEntry.COLUMN_MAX_TEMP,WeatherContract.WeatherEntry.COLUMN_WEATHER_ID},null,null,null);
                if(cursor!=null)
                {
                    cursor.moveToFirst();
                    ...
                    if(result.isSuccess())
                    {
                        ...
                        dataMap.putInt(KEY_WEATHER_ID,Integer.parseInt(cursor.getString(cursor.getColumnIndex(WeatherContract.WeatherEntry.COLUMN_WEATHER_ID))));
                        PutDataRequest putDataRequest=putDataMapRequest.asPutDataRequest();
                        Wearable.DataApi.putDataItem(apiClient,putDataRequest);

                        Log.d(TAG,"Data To Watchface");
                    }
                    else
                    {
